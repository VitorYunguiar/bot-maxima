...
Para verificar se o Servico de Agendamento do Oracle esta rodando, executar a seguinte query SQL:
...
Esta query identifica as sessoes do Oracle Scheduler (CJQ) e jobs (J0) que estao ativos no banco de dados.
