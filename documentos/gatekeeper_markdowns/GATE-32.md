...
- Afirmacoes sem suporte: A exibição de “Valor Un:” na tela de negociação depende do atendimento simultâneo de três condições. | Na análise, foi identificado que apenas ajustar valor de venda ou embalagem não atende à regra de exibição do campo. | O sistema considera especificamente a combinação entre permissão, parâmetro e QTUNIT do produto. | Ajustar a QTUNIT do produto 941 na rotina 203. | Responsável: Cliente.
